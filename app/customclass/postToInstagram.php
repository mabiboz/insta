...
class postToInstagram{
    ...
    public function Login($username="", $password=""){
     ...
     public function checkLogin($username="", $password=""){
        ...
        $this->cookies = $arrUidAndCooike[1];
     //  dd(($arrUidAndCooike));
       if(gettype($arrUidAndCooike)=='array'){
           $arrUidAndCooike='{"message": "checkpoint_required", "checkpoint_url": "https://i.instagram.com/challenge/13796875958/n9bxD6ql7i/", "lock": true, "status": "fail", "error_type": "checkpoint_challenge_required"}';
           return json_decode($arrUidAndCooike,true);
       }
       else{
        return json_decode($arrUidAndCooike,true);
       }
