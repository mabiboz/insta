        ...
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                    {{ isset($title) ? $title : 'لیست صفحات' }}
                    <a href="{{route('admin.page.all',1)}}" class="btn btn-xs btn-info">بیشترین قیمت</a>
                    <a href="{{route('admin.page.all',2)}}" class="btn btn-xs btn-success">کمترین قیمت</a>
                    <a href="{{route('admin.page.all',3)}}" class="btn btn-xs btn-warning">بیشترین دنبال کننده</a>
                    <a href="{{route('admin.page.all',4)}}" class="btn btn-xs btn-primary"> کمترین دنبال کننده</a>
                ...
                <table class="table table-striped table-advance table-hover">
                    ...
                    @foreach($pages as $page)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route("admin.pages.edit",$page) }}" target="_blank" class="btn btn-primary btn-xs"><i
